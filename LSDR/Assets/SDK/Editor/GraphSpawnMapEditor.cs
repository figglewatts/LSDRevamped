...
namespace LSDR.SDK
{
    public class GraphSpawnMapEditor : EditorWindow
    {
        ...
        {
            get { return _graphSpawnMap; }
            set
            {
                _graphSpawnMap = value;
            }
        }
        ...
        private void drawDreamBox()
        {
            ...
            _dreamBoxRect = new Rect(xPos, _graphTextureRect.y + toolbarHeight, position.width - xPos, position.height - toolbarHeight);
        ...
        private void OnEnable()
        {
            ...
            _graphTexture = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/SDK/dreamGraph.png");
