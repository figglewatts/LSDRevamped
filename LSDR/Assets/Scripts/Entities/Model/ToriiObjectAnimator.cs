...
public class ToriiObjectAnimator : MonoBehaviour
{
	...
	{
		get { return ToriiObject.Animations[CurrentAnimationHandle]; }
	}
	...
	{
		get { return CurrentAnimation.Keyframes[CurrentKeyframeIndex]; }
	}

	public TKEYFRAME NextKeyframe
	{
		get { return CurrentAnimation.Keyframes[CurrentKeyframeIndex + 1]; }
	}
