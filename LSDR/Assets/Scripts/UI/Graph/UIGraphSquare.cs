...
namespace LSDR.UI.Graph
{
    ...
    public class UIGraphSquare : MonoBehaviour
    {
        ...
        [Range(min: 1, max: 5)] public int ColourModifier;
        ...
        {
            // set initial values
            _graphSquareImage.rectTransform.anchoredPosition = new Vector2(
                (Position.x + ANCHOR_OFFSET) * SQUARE_DIMENSION,
        ...
        public void Update()
        {
            ...
            if (MostRecent)
            {
                if (Time.timeSinceLevelLoad % FLASH_TIME > FLASH_TIME / 2) { _graphSquareImage.color = Color.red; }
                    ...
                    _graphSquareImage.color =
                        new Color(0.2F * ColourModifier, 0.2F * ColourModifier, 0.2F * ColourModifier);
            }
            else
                _graphSquareImage.color =
                    new Color(0.2F * ColourModifier, 0.2F * ColourModifier, 0.2F * ColourModifier);
